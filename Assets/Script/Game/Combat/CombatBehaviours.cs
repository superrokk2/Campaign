...
{
    /// <summary>Transform 위치 변경만 담당하며 입력 해석과 타깃 판단은 알지 못합니다.</summary>
    public sealed class MovementMotor
    {
        ...
        {
            // 대각선 이동이 축 이동보다 빨라지지 않도록 먼저 정규화합니다.
    ...
    /// <summary>타깃 획득 책임을 레지스트리에 위임하는 작은 전투 기능입니다.</summary>
    ...
    /// <summary>
    /// 공격 가능 여부, 쿨다운 소비, 피해 전달만 담당합니다.
    /// 애니메이션과 피격 표현은 Controller와 View 경계에서 처리합니다.
    /// </summary>
