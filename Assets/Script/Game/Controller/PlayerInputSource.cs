...
{
    /// <summary>
    /// 게임 흐름이 특정 입력 장치나 Input System API를 직접 알지 않게 하는 경계.
    /// 테스트에서는 고정 벡터를 반환하는 대역 구현을 주입할 수 있다.
    /// </summary>
    ...
    /// <summary>현재 프로토타입의 키보드 입력을 새 Input System으로 읽는 어댑터.</summary>
    public sealed class UnityInputSystemSource : IPlayerInputSource
    {
        public Vector2 ReadMovement()
        {
            ...
            // 대각선 입력의 크기를 1로 제한해 이동 속도를 일정하게 유지한다.
